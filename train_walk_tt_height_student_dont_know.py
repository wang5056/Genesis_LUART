...
def get_cfgs():
    env_cfg = {
        ...
        # termination
        'termination_if_roll_greater_than': 0.5,
        'termination_if_pitch_greater_than': 0.5,
    ...
    reward_cfg = {
        ...
        # },
        'reward_scales': {
            'tracking_lin_vel': 1.2,      # Increase from 1.0 to 2.5 for stronger emphasis
