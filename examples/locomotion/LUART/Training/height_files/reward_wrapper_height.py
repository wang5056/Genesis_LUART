...
from locomotion_env_height_student_knows import *
...
class Go2(LocoEnv):
    ...
    # '''reward for height with tracking sigma'''
    # def _reward_base_height(self):
    #     base_height = self.base_pos[:, 2]
    #     base_height_target = self.commands[:, 3]
    #     height_error = torch.square(base_height - base_height_target)
    #     return torch.exp(-height_error / self.reward_cfg['tracking_sigma'])  # Reuse tracking_sigma    
