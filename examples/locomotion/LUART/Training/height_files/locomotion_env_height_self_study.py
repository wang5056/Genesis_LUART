...
class LocoEnv:
    def __init__(
        ...
        if env_cfg['use_implicit_controller']:  # this is False in the training code
            sim_dt = self.dt
    ...
    def _prepare_obs_noise(self):
        ...
        self.obs_noise[9:17] = self.obs_cfg['obs_noise']['dof_pos']
        self.obs_noise[17:25] = self.obs_cfg['obs_noise']['dof_vel']  # this is the only place I change!!!
